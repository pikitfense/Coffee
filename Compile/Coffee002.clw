   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('COFFEE002.INC'),ONCE        !Local module procedure declarations
                       INCLUDE('COFFEE003.INC'),ONCE        !Req'd for module callout resolution
                     END
...
ViewPosition           STRING(2048)                   !Entry's view position
                     END
